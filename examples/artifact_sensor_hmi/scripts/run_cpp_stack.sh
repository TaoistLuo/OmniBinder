...
SESSION_NAME="omnibinder-artifact-cpp"
DETACH=0
SM_PORT=9900
...
tmux send-keys -t "${SESSION_NAME}:0.1" "cd ${EXAMPLE_BUILD_DIR}/bin && ./sensor_cpp" Enter
tmux send-keys -t "${SESSION_NAME}:0.2" "cd ${EXAMPLE_BUILD_DIR}/bin && ./hmi_cpp" Enter
