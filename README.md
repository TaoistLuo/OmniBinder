...
|--------|--------|--------|-----------|-----------|------|
| RPC Echo (0 bytes) | 1000 | 68.8 us | 96 us | 130 us | 空 payload，主要反映协议与调度开销 |
| RPC Echo (256 bytes) | 1000 | 69.1 us | 97 us | 133 us | 常见小 payload RPC |
| RPC Echo (1024 bytes) | 1000 | 69.1 us | 102 us | 143 us | 1KB 级 payload |
| RPC Echo (4096 bytes) | 1000 | 73.9 us | 107 us | 137 us | 4KB payload，测试服务显式放大 SHM ring |
| RPC Echo (8192 bytes) | 1000 | 91.9 us | 125 us | 169 us | 8KB payload，测试服务显式放大 SHM ring |
| RPC Add (2 x int32) | 1000 | 66.5 us | 101 us | 133 us | 小计算型 RPC |
| Topic pub/sub (64 bytes) | 1000 | 42.4 us | 76 us | 104 us | 小广播数据，发布 → 订阅者回调 |
| Topic pub/sub (256 bytes) | 1000 | 41.8 us | 74 us | 93 us | 常见小广播数据 |
| Topic pub/sub (1024 bytes) | 1000 | 38.4 us | 71 us | 89 us | 1KB 广播数据 |
| Topic pub/sub (8192 bytes) | 1000 | 54.8 us | 89 us | 114 us | 8KB 广播数据 |

从报告中的完整数据看：

- **0~1024 bytes 常见 RPC** 在当前机器上的平均值约为 **66.5~69.1 us**
- **4096~8192 bytes payload RPC** 在显式放大 SHM ring 的测试配置下，平均值约为 **73.9~91.9 us**
- **Topic pub/sub** 在当前机器上的平均值约为 **38.4~54.8 us**
