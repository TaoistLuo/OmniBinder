...
|--------|--------|--------|-----------|-----------|------|
| RPC Echo (0 bytes) | 1000 | 70.5 us | 93 us | 123 us | 空 payload，主要反映协议与调度开销 |
| RPC Echo (64 bytes) | 1000 | 68.8 us | 92 us | 111 us | 常见小 payload RPC |
| RPC Echo (256 bytes) | 1000 | 73.0 us | 97 us | 112 us | 常见小 payload RPC |
| RPC Echo (1024 bytes) | 1000 | 70.2 us | 97 us | 121 us | 1KB 级 payload |
| RPC Echo (4096 bytes) | 1000 | 75.7 us | 101 us | 123 us | 4KB payload，测试服务显式放大 SHM ring |
| RPC Echo (8192 bytes) | 1000 | 83.5 us | 112 us | 141 us | 8KB payload，测试服务显式放大 SHM ring |
| RPC Add (2 x int32) | 1000 | 71.2 us | 91 us | 118 us | 小计算型 RPC |
| Topic pub/sub (64 bytes) | 1000 | 31.2 us | 55 us | 66 us | 小广播数据，发布 → 订阅者回调 |
| Topic pub/sub (256 bytes) | 1000 | 30.4 us | 57 us | 74 us | 常见小广播数据 |
| Topic pub/sub (1024 bytes) | 1000 | 32.1 us | 58 us | 74 us | 1KB 广播数据 |
| Topic pub/sub (8192 bytes) | 1000 | 41.0 us | 65 us | 79 us | 8KB 广播数据 |

从报告中的完整数据看：

- **0~1024 bytes 常见 RPC** 在当前机器上的平均值约为 **68.8~73.0 us**
- **4096~8192 bytes payload RPC** 在显式放大 SHM ring 的测试配置下，平均值约为 **73.8~79.9 us**
- **Topic pub/sub** 在当前机器上的平均值约为 **31.0~41.9 us**
