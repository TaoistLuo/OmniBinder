...
|--------|--------|--------|-----------|-----------|------|
| RPC Echo (0 bytes) | 1000 | 68.5 us | 85 us | 101 us | 空 payload，主要反映协议与调度开销 |
| RPC Echo (256 bytes) | 1000 | 68.3 us | 86 us | 110 us | 常见小 payload RPC |
| RPC Echo (1024 bytes) | 1000 | 70.5 us | 89 us | 109 us | 1KB 级 payload |
| RPC Echo (4096 bytes) | 1000 | 74.2 us | 97 us | 122 us | 4KB payload，测试服务显式放大 SHM ring |
| RPC Echo (8192 bytes) | 1000 | 86.4 us | 111 us | 138 us | 8KB payload，测试服务显式放大 SHM ring |
| RPC Add (2 x int32) | 1000 | 73.6 us | 93 us | 109 us | 小计算型 RPC |
| Topic pub/sub (64 bytes) | 1000 | 28.4 us | 52 us | 69 us | 小广播数据，发布 → 订阅者回调 |
| Topic pub/sub (256 bytes) | 1000 | 29.4 us | 55 us | 72 us | 常见小广播数据 |
| Topic pub/sub (1024 bytes) | 1000 | 29.2 us | 54 us | 72 us | 1KB 广播数据 |
| Topic pub/sub (8192 bytes) | 1000 | 38.6 us | 64 us | 84 us | 8KB 广播数据 |

从报告中的完整数据看：

- **0~1024 bytes 常见 RPC** 在当前机器上的平均值约为 **68.3~70.5 us**
- **4096~8192 bytes payload RPC** 在显式放大 SHM ring 的测试配置下，平均值约为 **74.2~86.4 us**
- **Topic pub/sub** 在当前机器上的平均值约为 **28.4~38.6 us**
